<?php
/**
 * скомпилировать compiler.twig 3 раза и убедитс€, что все осталось разумно добро и вечно
 */
...
/**
 * компилировать шаблон $orig, использу€ tpl - compiler
 * получившийс€ tpl - класс назвать compiler1
 * результат трансл€ции выдать в переменную $dst, или eval
 *
 * @param $compiler
 * @param $compiler1
 * @param null $dst
